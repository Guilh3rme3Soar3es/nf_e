...
{
    public class CarrierRegisterCommand
    {
        ...
        class Validator : AbstractValidator<CarrierRegisterCommand>
        {
            public Validator()
            {
                RuleFor(r => r.Address)
                ...
                RuleFor(r => r.PersonType)
                    .NotEqual(PersonType.INVALID).WithMessage("Transportador com tipo de pessoa não informado.");
